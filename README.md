...
├── shoes.html              # Products listing page
├── contact.html            # Contact page
├── racing boots.html       # Racing boots page
│
├── css/
...
└── images/
    ...
    ├── boots/              # Boot category images
    ├── sneakers/           # Sneaker category images
    ├── flipflops/          # Flip flop images
    ├── loafers/            # Loafer images
    ├── sandals/            # Sandal images
    └── soccer/              # Soccer shoe images
```

## 📄 Pages

### 1. **Homepage (index.html)**
- Hero carousel with featured product collections
- New arrivals section
- High-performance racing boots showcase
- Product gallery with ratings and pricing
...
### 5. **Racing Boots (racing boots.html)**
...
The project is a static website, so you can:
...
### Homepage
- Interactive carousel with product showcases
- Clean, modern layout
